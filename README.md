...
[cite_start]Ce script Python a été développé pour analyser les transformations subies par le fluide frigorigène R404a[cite: 27]. Le programme permet de calculer et d'afficher les coefficients de performance (COP) ainsi que les puissances associées aux quatre composants principaux du système :
* [cite_start]Évaporateur (Vaporisation isobare) [cite: 45, 46]
...
## Technologies
* [cite_start]Python 3 [cite: 440]
* [cite_start]CoolProp (Accès aux tables thermodynamiques) [cite: 113]
* [cite_start]NumPy (Gestion des tableaux de données) [cite: 442]
* [cite_start]Matplotlib (Génération du diagramme quantitatif ln(p)-h) [cite: 443, 471]
